...
public class CreateVideoPost extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        storageReference =
                FirebaseStorage.getInstance().getReference().child("videoposts");
    ...
    private void uploadvideo() {
        if (videouri != null) {
            ...
            reference.putFile(videouri).addOnSuccessListener(new
                ...
                public void onFailure(@NonNull Exception e) {
                    Toast.makeText(CreateVideoPost.this, "Failed " +
